...
EGMS3DFile::EGMS3DFile():m_pMeshes(NULL),m_pTriangles(NULL),m_pVertices(NULL),m_pTexture(NULL),
...
BOOL EGMS3DFile::Load(char *pModelFile,vector3d& scale)
{
	m_fScale = scale;
	...
	m_pTexture=new EGCTexture[m_numTexture];
...
BOOL EGMS3DFile::LoadTexFromIni(char* filename,char* index)
{
