...
BOOL EGCTexture::InitTexture(char *filename,BOOL bAlpha,BOOL bTga)
{
...
int EGCTexture::GetPower(int iSize)
{
...
void EGCTexture::GetImageData(char *filename,BOOL bAlpha,BOOL bTga)
{
	unsigned char r,g,b;
	r = 0;g=0;b=0;
	m_pImage = new EGImage;
